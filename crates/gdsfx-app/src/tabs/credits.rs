...
const CREDIT_LINKS: fn(name: &str) -> Option<&str> = gdsfx_build::get_output!(include!("credits/links.rs"));
const THEME_CREDITS: fn(theme: &str) -> Option<&str> = gdsfx_build::get_output!(include!("credits/themes.rs"));
const TRANSLATORS: fn(locale: &str) -> &[&str] = gdsfx_build::get_output!(include!("credits/translators.rs"));
