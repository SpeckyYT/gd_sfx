...
const SOURCE_FILE: &str = gdsfx_shared::workspace_path!("locales/en_US.json");
const TARGET_FILE: &str = gdsfx_shared::workspace_path!(".vscode/schemas/locale_schema.json");
